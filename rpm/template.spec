...
Name:           ros-rolling-ignition-math6-vendor
Version:        0.2.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS ignition_math6_vendor package

License:        Apache License 2.0
URL:            https://github.com/ignitionrobotics/ign-math
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-rolling-ignition-cmake2-vendor
Requires:       ros-rolling-ros-workspace
BuildRequires:  cmake
BuildRequires:  eigen3-devel
BuildRequires:  git
BuildRequires:  ros-rolling-ament-cmake-test
BuildRequires:  ros-rolling-ignition-cmake2-vendor
